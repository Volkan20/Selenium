...
public class ElementCommands {
    public static void main(String[] args) {
        ...
        boolean isMarriedRadioButtonEnable = marriedRadioButton.isEnabled();
        System.out.println(isMarriedRadioButtonEnable);

        if (!isMarriedRadioButtonEnable) {
            System.out.println("Not Enabled");
        } else {
            System.out.println("Enabled");
        }

        boolean isMarriedRadioButtonDisplay = marriedRadioButton.isDisplayed();
        System.out.println(isMarriedRadioButtonDisplay);
